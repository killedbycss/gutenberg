...
export const PURPOSES = [
  ...
  { id: 'desktop-hd', label: 'Десктоп — 16:9', group: 'Цифровые устройства', width: 1920, height: 1080, unit: 'px', dpi: 72, palette: 'mono', safe: { x:.025,y:.045,w:.95,h:.91 }, scale: { headlineCap:.14,ratio:1.5,marginX:.055,marginY:.08,minBody:.025 } },
